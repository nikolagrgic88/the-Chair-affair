...
import { ApiResponse, ContextType } from '../App';
...
const Product = () => {
	...
	const loadedProductsData = useRouteLoaderData('root-page') as ApiResponse;
	...
	const product = getProduct(productId!, loadedProductsData);
